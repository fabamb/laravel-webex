...
use Fabamb\LaravelWebex\Exceptions\CouldNotCreateNotification;
use Fabamb\LaravelWebex\WebexMessage;
use Fabamb\LaravelWebex\WebexMessageAttachment;
use Fabamb\LaravelWebex\WebexMessageFile;
...
class WebexMessageTest extends TestCase
{
    ...
    public function test_message_with_multiple_files()
    {
    ...
    public function test_message_with_attachment_and_file()
    {
    ...
    public function test_message_with_multiple_attachments()
    {
    ...
    public function test_message_with_file_and_attachment()
    {
        $this->expectExceptionObject(CouldNotCreateNotification::messageWithFileAndAttachmentNotSupported());
        (new WebexMessage)
            ->file(function (WebexMessageFile $file) {
