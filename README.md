...
This package is a Laravel 12/13-compatible fork based on [laravel-notification-channels/webex](https://github.com/laravel-notification-channels/webex).

[![Latest Version on Packagist](https://img.shields.io/packagist/v/fabamb/laravel-webex.svg?style=flat-square)](https://packagist.org/packages/fabamb/laravel-webex)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Build Status](https://img.shields.io/github/actions/workflow/status/fabamb/laravel-webex/test.yml?branch=main&style=flat-square)](https://github.com/fabamb/laravel-webex/actions/workflows/test.yml)
[![Total Downloads](https://img.shields.io/packagist/dt/fabamb/laravel-webex.svg?style=flat-square)](https://packagist.org/packages/fabamb/laravel-webex)

This package makes it easy to send notifications using [Webex](https://www.webex.com/) with Laravel 12 and 13.

```php
/**
 * Get the Webex Message representation of the notification.
 *
 * @return \Fabamb\LaravelWebex\WebexMessage
 *
 * @throws \Fabamb\LaravelWebex\Exceptions\CouldNotCreateNotification
 */
...
- [Installation](#installation)
  ...
  - [Add Webex configuration](#add-webex-configuration)
- [Usage](#usage)
...
```bash
composer require fabamb/laravel-webex
```

### Add Webex configuration

The package provides `config/webex.php`. Publish it with:
...
After registering the package in a Laravel application, the `webex:send` command
can be used to test the configured bot without creating a Notification class:

```bash
php artisan webex:send 'MyApp test message' --room-id='<room-id>'
...
method whose return value includes `'webex'` or `Fabamb\LaravelWebex\WebexChannel::class`.
For example:
...
use Fabamb\LaravelWebex\WebexChannel;
...
a `\Fabamb\LaravelWebex\WebexMessage` instance. Webex messages may contain text content
...
All messaging classes are under the `\Fabamb\LaravelWebex` namespace.
